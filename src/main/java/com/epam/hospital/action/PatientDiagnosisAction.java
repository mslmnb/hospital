...
import static com.epam.hospital.servlet.AppServletContextListner.CONTEXT_PARAMETER_FOR_PATIENT_DIAGNOSIS_SERVICE;
...
public class PatientDiagnosisAction extends AbstractActionWithService {
    ...
    public PatientDiagnosisAction() {
        super(URI, CONTEXT_PARAMETER_FOR_PATIENT_DIAGNOSIS_SERVICE);
    }

    private void setService(Object service) {
        this.service = (PatientDiagnosisService) service;
    }
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        switch (direction) {
            case FORWARD_TO_JSP:
                ...
                break;
            case GET_ALL:
                String patientIdAsString = (String) request.getParameter(ID_PARAMETER);
            ...
            case SAVE:
                ...
                try {
                    service.save(idAsString, patientIdAsString, dateAsString,
                                 diagnosisIdAsString, diagnosisTypeIdAsString);
                    result = "";
